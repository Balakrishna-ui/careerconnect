...
import { ADMIN_JOB_SEEKERS } from "@/lib/admin-mock-data";
import { Card, CardContent, CardHeader } from "@/components/ui/card";
import { StatusBadge } from "@/components/admin/StatusBadge";
import { Search, Filter, MoreVertical, DollarSign, Calendar, Download, Ban } from "lucide-react";
...
export default function JobSeekersManagement() {
  ...
  const filteredSeekers = ADMIN_JOB_SEEKERS.filter(
    (s) =>

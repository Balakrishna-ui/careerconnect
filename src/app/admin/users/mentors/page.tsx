...
import { Search, Filter, MoreVertical, Shield, Star, Clock, DollarSign, Download, Plus } from "lucide-react";
...
export default function MentorsManagement() {
  ...
  const filteredMentors = ADMIN_MENTORS.filter(
    (m) =>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-4 text-xs">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="font-medium">{mentor.rating > 0 ? mentor.rating : "-"}</span>
                        </div>

...
import { getAdminPayments } from "@/actions/admin-dashboard-actions";

export default function PaymentsManagement() {
  const fetcher = <T,>(action: () => Promise<T>) => action();
  const { data: payments, isLoading, mutate } = useSWR('adminPayments', () => fetcher(getAdminPayments), { refreshInterval: 10000 });
